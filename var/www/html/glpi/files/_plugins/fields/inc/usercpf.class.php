...
class PluginFieldsUsercpf extends PluginFieldsAbstractContainerInstance
{
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `itemtype`                         VARCHAR(255) DEFAULT 'User',
                  `plugin_fields_containers_id`      INT          {$default_key_sign} NOT NULL DEFAULT '2',
                  PRIMARY KEY                        (`id`),
